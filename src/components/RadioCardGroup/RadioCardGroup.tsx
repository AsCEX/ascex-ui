...
import { cx, focusInput, focusRing } from "@utils/utils"
    ...
    return (
        <RadioGroupPrimitives.Item
            ...
            className={cx(
                ...
                // disabled
                "data-[disabled]:border-gray-100 data-[disabled]:dark:border-gray-lemon-dark-border",
                "data-[disabled]:bg-gray-50 data-[disabled]:shadow-none data-[disabled]:dark:bg-gray-lemon-dark-primary",
                focusInput,
                className,
            )}
            {...props}
